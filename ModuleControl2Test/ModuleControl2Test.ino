...
int testTime[15] = {200, 400, 800, 1200, 1600, 2200, 2500, 3000, 3300, 3600, 3900, 4200, 4500, 4800, 5100};
float testVt[16] = {75,  71,   73,   89,   86,   86,   75,   73,   71,   75,   78,   84,   87,   75,   73, 74 };
int timeCount = 0;
...
void loop()
{
  ...
  int i = 0;
  while(timeCount > testTime[i] && i<15){
    i++;
  }
  timeCount++;
  Serial.print("T:");
